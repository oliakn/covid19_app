...
const World = () => {
    ...
    return (
        ...
        <Layout>
            {Object.keys(world).length === 0 ? <Spinner/> :
                <div className="container world__container">
                    {
                        [world].map(rec => (
                            <div className='boxes'>
                                <h2 className='boxes__title'>WORLDWIDE COVID-19 STATISTICS</h2>
                                <h3 className='boxes__title-data'>Date: 14.04.2021<span
                                    className='boxes__title-data__ml'>{rec.country}</span></h3>
                                <div className="row">
                                    <div className="col-4">
                                        <div className="boxes-box con">
                                            <div className="boxes-box__cont">
                                                <h3 className='boxes-box__title con'>New Confirmed:<span
                                                    className='boxes-box__subtitle '>{rec.todayCases}</span></h3>
                                                <h3 className='boxes-box__title con'>Total Confirmed:<span
                                                    className='boxes-box__subtitle '><b>{rec.cases}</b></span>
                                                </h3>
                                            </div>
                                        ...
                                        <div className="boxes-box">
                                            <div className="boxes-box__cont">
                                                <h3 className='boxes-box__title deth'>New Deaths:<span
                                                    className='boxes-box__subtitle '>{rec.todayDeaths}</span></h3>
                                                <h3 className='boxes-box__title deth'>Total Deaths:<span
                                                    className='boxes-box__subtitle '><b>{rec.deaths}</b></span></h3>
                                            </div>
                                        ...
                                        <div className="boxes-box">
                                            <div className="boxes-box__cont">
                                                <h3 className='boxes-box__title rec'>New Recovered: <span
                                                    className='boxes-box__subtitle'>{rec.todayRecovered}</span></h3>
                                                <h3 className='boxes-box__title rec'>Total Recovered: <span
                                                    className='boxes-box__subtitle'><b>{rec.recovered}</b></span>
                                                </h3>
                                            </div>
